...
const Contact = () => {
  ...
  return (
    <form
      ...
      className="w-full max-w-3xl bg-white rounded-lg shadow-lg m-8 mx-auto border-2 border-primary"
    >
      <div>
      ...
      <div className="flex flex-wrap m-7 mb-6">
        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <label
            className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 m-2"
            for="grid-first-name"
          >
            First Name
          </label>
       ...
       border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none
        ...
        <div className="w-full md:w-1/2 px-3 mx-auto">
          <div className>
            <label className=" block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 m-4 text-center">
              Message
            </label>
            <textarea
              className=" appearance-none block w-full bg-gray-200 text-gray-700 border
