          ...
          <div className="m-4">
            {user && (
              <div>
                ...
                <div
                  onClick={handleClick}
                  className="w-20 h-10 mx-auto bg-indigo-600 text-white rounded-lg p-2 m-2.5 border border-white cursor-pointer"
                >
                  Logout
                </div>
              </div>
            ...
            <button
              ...
              className="relative w-20 h-7 justify-self-center bg-indigo-600 border-2 border-stone-50"
            >
              <i className="fa-solid badge fa-cart-shopping text-white "></i>
              <span className="absolute -top-2.5 -right-2.5 w-6 h-6 bg-red-700 text-white items-center rounded-full">
                {productsCount}
              </span>
            </button>
          </div>
